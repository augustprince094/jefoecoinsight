...
export const feedData: RegionFeedData[] = [
  ...
  },
  {
    ...
    diets: {
      Starter: [
        { name: 'Corn', quantity: 436.74, cost: 21, carbonFootprint: 3 },
        { name: 'Soybean Meal', quantity: 375.58, cost: 29.8, carbonFootprint: 6 },
        { name: 'Wheat', quantity: 100, cost: 19, carbonFootprint: 6 },
        { name: 'Coconut Oil', quantity: 30.74, cost: 73, carbonFootprint: 0.9 },
        { name: 'Fish meal', quantity: 20, cost: 68, carbonFootprint: 0.9 },
        { name: 'Synthetic Amino Acid', quantity: 5.7, cost: 460, carbonFootprint: 3.6 },
        { name: 'Other Raw Materials', quantity: 31.23, cost: 36, carbonFootprint: 3.2 },
      ],
      Grower: [
        { name: 'Corn', quantity: 505.7, cost: 21, carbonFootprint: 3 },
        { name: 'Soybean Meal', quantity: 316.73, cost: 29.8, carbonFootprint: 6 },
        { name: 'Wheat', quantity: 100, cost: 19, carbonFootprint: 6 },
        { name: 'Coconut Oil', quantity: 22.62, cost: 73, carbonFootprint: 0.9 },
        { name: 'Fish meal', quantity: 27.5, cost: 68, carbonFootprint: 0.9 },
        { name: 'Synthetic Amino Acid', quantity: 5.33, cost: 460, carbonFootprint: 3.6 },
        { name: 'Other Raw Materials', quantity: 22.1, cost: 36, carbonFootprint: 3.2 },
      ],
      Finisher: [
        { name: 'Corn', quantity: 542.5, cost: 21, carbonFootprint: 3 },
        { name: 'Soybean Meal', quantity: 271.66, cost: 29.8, carbonFootprint: 6 },
        { name: 'Wheat', quantity: 100, cost: 19, carbonFootprint: 6 },
        { name: 'Coconut Oil', quantity: 31.20, cost: 73, carbonFootprint: 0.9 },
        { name: 'Fish meal', quantity: 30, cost: 68, carbonFootprint: 0.9 },
        { name: 'Synthetic Amino Acid', quantity: 4.83, cost: 460, carbonFootprint: 3.6 },
        { name: 'Other Raw Materials', quantity: 19.9, cost: 36, carbonFootprint: 3.2 },
      ]
    }
  },
  {
